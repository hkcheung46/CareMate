...
public class CreateNewTaskActivity extends AppCompatActivity {
    ...
    private RadioGroup mImportanceRgp;
    ...
    private RadioGroup mEventTaskTygeRgp;
    private LinearLayout mEndDateTimeLinearLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImportanceRgp = (RadioGroup) findViewById(R.id.importanceRgp);
        //mAllDaySwitch = (Switch) findViewById(R.id.allDaySwitch);
        mEndDateTimeLinearLayout = (LinearLayout) findViewById(R.id.endDateTimeLinearLayout);
        mEventTaskTygeRgp = (RadioGroup) findViewById(R.id.taskTypeRgp);
        ...
        mEventTaskTygeRgp.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.event_rbtn) {
                    mEndDateTimeLinearLayout.setVisibility(View.VISIBLE);
                } else if (checkedId == R.id.task_rbtn) {
                    mEndDateTimeLinearLayout.setVisibility(View.GONE);
                }
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isInputValid()) {
                    ...
                    String taskType;
                    switch (mImportanceRgp.getCheckedRadioButtonId()) {
                    ...
                    double taskStartDateTime;
                    double taskEndDateTime;

                    if (mEventTaskTygeRgp.getCheckedRadioButtonId()==R.id.event_rbtn){
                        taskStartDateTime = mEventStartCalendar.getTimeInMillis();
                        taskEndDateTime = mEventEndCalendar.getTimeInMillis();
                    }else{
                        taskStartDateTime = mEventStartCalendar.getTimeInMillis();
                        taskEndDateTime = taskStartDateTime;
                    }
                    ...
                    CustomTasks toBeInsertedTask = new CustomTasks(taskName, status, taskType, taskStartDateTime, taskEndDateTime, createDate, taskDescription, groupId, creatorUid, eventTaskType);
    ...
    private boolean isInputValid() {
        ...
        if (mImportanceRgp.getCheckedRadioButtonId() == -1) {
            isValid = false;
        }

        if (mEventTaskTygeRgp.getCheckedRadioButtonId()==-1){
            isValid=false;
        }
        ...
        boolean isEvent = (mEventTaskTygeRgp.getCheckedRadioButtonId()==R.id.event_rbtn);

        if (mEventStartCalendar.compareTo(mEventEndCalendar) > 0 && isEvent ) {
            isValid = false;
        }
