...
public class ActivePollingListFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_active_polling, container, false);
    ...
    private void reloadActivePollingList() {
                                ...
                                pollRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot2) {
                                        for (DataSnapshot pollingSnapshot : dataSnapshot2.getChildren()) {
                                            ...
                                            if (polling.getStatus().equals(Polling.ACTIVE_POLLING_STATUS)) {
